...
namespace KafkaClient.Protocol
{
    ...
    {
        public override string ToString() => $"{{{this.RequestToString()},create_topic_requests:[{Topics.ToStrings()}],timeout:{Timeout.TotalMilliseconds:##########},validate_only:{ValidateOnly}}}";
