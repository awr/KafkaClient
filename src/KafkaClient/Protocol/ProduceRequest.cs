...
namespace KafkaClient.Protocol
{
    ...
    {
        public override string ToString() => $"{{{this.RequestToString()},transactional_id:{TransactionalId},acks:{Acks},timeout:{Timeout.TotalMilliseconds:##########},topics:[{Topics.ToStrings()}]}}";
